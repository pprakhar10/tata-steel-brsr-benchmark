# BRSR Analysis: CSR, Products & Consumer Responsibility

*Generated: 2026-04-28 | Metrics: 4 | Companies: 4 | Years: FY2022-23, FY2023-24, FY2024-25*


## Session context


You are analysing **CSR, Products & Consumer Responsibility** disclosures from BRSR filings for 4 Indian steel companies across FY2022-23, FY2023-24, and FY2024-25. Coverage: BRSR Principle 2 — Sustainable Products + Principle 8 — Inclusive Growth + Principle 9 — Consumer Responsibility.
...
**Metrics covered in this session (4):** EnvironmentalAndSocialParametersRelevantToTheProductAsAPercentageToTotalTurnover, RecyclingAndOrSafeDisposalAsAPercentageToTotalTurnover, NumberOfDealersOrDistributorsToWhomSalesAreMade, NumberOfTradingHousesWherePurchasesAreMade
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Products with Env/Social Info (% of turnover) | % | 50 ⚠consolidated | 53 | 52 | 100 | 100 | 100 | 100 | 100 | 0 | 0 | 100 | 100 |
| Products with Recycling/Safe Disposal Info (% of turnover) | % | 19 ⚠consolidated | 16 | 17 | 100 | 100 | 100 | 100 | 100 | 0 | 4.1 | 100 | 100 |
| Number of Dealers / Distributors | — | — | 1,176.0 | 1,661.0 | — | 296 | 270 | — | 194 | 168 | — | 240 | 367 (P) |
| Number of Trading Houses (purchases) | — | — | 0 | 0 | — | 33 | 26 | — | 0 | 0 | — | 500 | 478 |
...
Now produce the analysis for all 4 metrics listed above, followed by the BENCHMARK block for topic key `csr-products-consumer`.