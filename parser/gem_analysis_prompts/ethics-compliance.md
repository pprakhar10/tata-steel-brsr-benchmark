# BRSR Analysis: Ethics & Compliance

*Generated: 2026-04-28 | Metrics: 2 | Companies: 4 | Years: FY2022-23, FY2023-24, FY2024-25*


## Session context


You are analysing **Ethics & Compliance** disclosures from BRSR filings for 4 Indian steel companies across FY2022-23, FY2023-24, and FY2024-25. Coverage: BRSR Principle 1 — Ethics & Transparency (Essential indicators).
...
**Metrics covered in this session (2):** TotalComplaintsReportedUnderSexualHarassmentOfWomenAtWorkplace, ComplaintsOnPOSHUpHeld
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| POSH Complaints — Total Reported | count | 38 ⚠consolidated | 20 | 43 | 0 | 1 | 7 | 8 | 3 | 3 | 0 | 0 | 5 |
| POSH Complaints — Upheld | count | — | 8 | 18 | — | 1 | 6 | — | 0 | 2 | — | 0 | 4 |
...
Now produce the analysis for all 2 metrics listed above, followed by the BENCHMARK block for topic key `ethics-compliance`.