# BRSR Analysis: Training & Development
...
You are analysing **Training & Development** disclosures from BRSR filings for 4 Indian steel companies across FY2022-23, FY2023-24, and FY2024-25. Coverage: BRSR Principle 3 — Employee Wellbeing (Essential indicators).
...
**Metrics covered in this session (4):** TrainingCoverage_Employees_HealthSafety, TrainingCoverage_Employees_SkillUpgradation, TrainingCoverage_Workers_HealthSafety, TrainingCoverage_Workers_SkillUpgradation
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Employee H&S Training Coverage (%) | % | 100 (P) ⚠consolidated | 100 (P) | 100 (P) | 100 (P) | 100 (P) | 100 (P) | 30.4 (P) | 32.21 | 15 (P) | 100 (P) | 50.04 (P) | 100 (P) |
| Employee Skill Training Coverage (%) | % | 100 (P) ⚠consolidated | 100 (P) | 100 (P) | 100 (P) | 100 (P) | 100 (P) | 32.6 (P) | 50.04 | 34 (P) | 100 (P) | 32.21 (P) | 100 (P) |
| Worker H&S Training Coverage (%) | % | 100 (P) ⚠consolidated | 100 (P) | 100 (P) | 100 (P) | 100 (P) | 100 (P) | 100 (P) | 100 (P) | 100 (P) | 100 (P) | 19.27 (P) | 100 (P) |
| Worker Skill Training Coverage (%) | % | 100 (P) ⚠consolidated | 100 (P) | 100 (P) | 100 (P) | 100 (P) | 100 (P) | — | — | — | 100 (P) | 3.73 (P) | 100 (P) |
...
Now produce the analysis for all 4 metrics listed above, followed by the BENCHMARK block for topic key `training-development`.